...
import static de.cidaas.jwk.UrlJwkProvider.urlForDomain;
...
public class JwkProviderBuilder {
     ...
     * <br><br> It can be a url link 'https://samples.cidaas.com' or just a domain 'samples.cidaas.com'.
     ...
     * <br><br> For example, when the domain is "samples.cidaas.com"
     * the jwks url that will be used is "https://samples.cidaas.com/.well-known/jwks.json"
